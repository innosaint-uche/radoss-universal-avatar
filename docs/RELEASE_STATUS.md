...
| Cross-platform unsigned build path | Workflow available; not yet run | Manual `Desktop build (unsigned)` workflow; signing and OS credential stores remain separate gates |
