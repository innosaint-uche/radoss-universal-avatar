...
/**
 * Install ReMe into an isolated NAAS-owned virtual environment and start it.
...
export async function projectApprovedMemory({ avatarId } = {}) {
  ...
  for (const item of items) {
    ...
    await postJob(status.endpoint, "write", {
      ...
      description: "Explicitly approved projection from the NAAS SQLite Avatar ledger.",
      content
    });
